...
# === УБИРАЕМ ПЕРЕНОСЫ СТРОК ВНУТРИ АБЗАЦЕВ ===
# Заменяем все последовательности \n (включая с пробелами) на один пробел
# Но оставляем пустые строки как границы абзацев
import re

# Нормализуем: заменяем множественные пробелы/переносы на один пробел
